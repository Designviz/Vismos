...
function Init()
{
    ...
    //$.post("https://vizmos.io/Editor/editorfunctions.php",{"postaction" : "save-node", "dir" : "Nodes/HTML/document.body", "node" : saveit});
...
class WebNodeDocument
{
    ...
    {
        $.get("https://vizmos.io/Editor/editorfunctions.php?action=load-node&path="+path, function(data, status){
        console.log(data);
...
{   
    ...
    $.get("https://vizmos.io/Editor/editorfunctions.php?action=load-nodes&dir="+dir, function(data, status){
